  ...
  <div class="app-container">
    <el-row class="el-center" :gutter="15">
      ...
      <el-form :model="queryParams" ref="queryForm" @submit.native.prevent>
       ...
       <el-col :span="8">
          <el-form-item label="状态" label-width="70px" prop="isIdentity" >
            <el-select  popper-class="select-dow" style="width: 70%;" v-model="queryParams.isIdentity" placeholder="请选择用户状态" clearable size="small">
              <el-option
