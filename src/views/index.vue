    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote style="font-size: 14px">
          <h2 class="text-warning">i衡水后台后台管理框架</h2>
        <p>
            衡水市智慧城市APP城市管理模块后台整体架构采用前后端分离的模式。系统采用目前主流的开发框架和开发模式，具有很强的功能拓展性、稳定性，方便后期产品升级。Web端使用 Vue框架和element组件库与后端动态交互，后端采用Spring Boot，Spring Cloud Alibaba，数据库mysql，注册中心、配置中心nacos，权限认证使用redis、流量控制框架Sentinel等。城市管理模块后台主要是满足智慧城市APP展示内容，进行用户管理、栏目划分、信息编辑、内容审核、内容管理、数据统计等功能，通过城市管理后台模块对智慧城市APP展示内容进行严谨、科学的展示。后台功能主要包括用户管理、菜单管理、角色管理、APP管理、文章管理、咨询与投诉等核心模块。
        </p>
        <p>
